...
from utils.styling import inject_css, glass_container, render_pills, section_header
...
with col_a:
    with glass_container("dataset_intro"):
        section_header(
...
with col_b:
    with glass_container("how_to_use"):
...
# ------------------------------------------------------------- PREVIEW ----
with glass_container("dataset_preview"):
